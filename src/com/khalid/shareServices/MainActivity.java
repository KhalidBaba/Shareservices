...
import com.khalid.shareServices.adapter.NavDrawerListAdapter;
...
import com.khalid.shareServices.model.NavDrawerItem;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Home
		navDrawerItems.add(new NavDrawerItem(navMenuTitles[0], navMenuIcons.getResourceId(0, -1), true, "50+"));
		// Find People
	 ...
	 public void onButtonClicker(View v)
	    {
			...
			case R.id.main_btn_eclair:
				intent = new Intent(this, Activity_service_emploi.class);
